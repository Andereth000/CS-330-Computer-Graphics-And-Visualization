...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// Callback is used to recieve mouse scolling events
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	// Only update camera position if the right mouse button is pressed
	if (isRightMouseButtonPressed) {
		...
		g_pCamera->ProcessMouseMovement(xOffset * 20, yOffset * 20);
	}
}
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// Switch between orthgraphic and perspective projections
